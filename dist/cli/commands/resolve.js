...
import { readAnnotationFile, resolveAnnotation, reopenAnnotation, } from '../../core/annotations.js';
// Create the command
export const resolveCommand = new Command('resolve')
    ...
    .action(async (file, partialId, options) => {
    try {
        ...
        const annotation = annotationFile.annotations.find(a => a.id.startsWith(partialId) || a.id === partialId);
        if (!annotation) {
