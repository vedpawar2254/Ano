...
import { setApproval, getApprovals, hasRequiredApprovals } from '../../core/annotations.js';
...
export const approveCommand = new Command('approve')
  ...
  .action(async (file: string, options: {
    ...
    try {
      ...
      // Determine status
      const status: ApprovalStatus = options.requestChanges
        ? 'changes_requested'
        : 'approved';
 ...
 */
async function checkApprovals(filePath: string, requiredCount: number): Promise<void> {
