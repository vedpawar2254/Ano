      ...
      <div className="relative max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              <span className="text-2xl font-semibold text-white">ano</span>
            </motion.a>
            <p className="text-white/40 max-w-sm mb-6">
              Collaborative annotation and review for AI-generated plans.
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#demo" className="text-white/40 hover:text-white transition-colors">Demo</a></li>
              <li><a href="#" className="text-white/40 hover:text-white transition-colors">Pricing</a></li>
              <li><a href="#" className="text-white/40 hover:text-white transition-colors">Changelog</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-white/40 hover:text-white transition-colors">Documentation</a></li>
              <li><a href="#" className="text-white/40 hover:text-white transition-colors">API Reference</a></li>
              <li><a href="#" className="text-white/40 hover:text-white transition-colors">Blog</a></li>
              <li><a href="#" className="text-white/40 hover:text-white transition-colors">Support</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/30">
            {new Date().getFullYear()} Ano. All rights reserved.
          </p>
