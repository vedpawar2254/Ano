        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10">
          ...
          <div className="flex gap-16">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#" className="text-zinc-400 hover:text-white transition-colors">Docs</a></li>
                <li><a href="https://github.com" className="text-zinc-400 hover:text-white transition-colors">GitHub</a></li>
